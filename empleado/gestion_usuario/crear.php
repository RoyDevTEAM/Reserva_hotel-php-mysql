...
<?php include_once '../../template/header.php'; ?>
    ...
    <div class="container mx-auto px-4 py-12">
        ...
        <form id="formCrearUsuario" method="POST" class="max-w-4xl mx-auto bg-white p-8 shadow rounded">
            ...
            <div class="flex flex-wrap -mx-3 mb-6">
                ...
                <div class="w-full md:w-1/2 px-3">
                    <label class="block uppercase tracking-wide text-gray-700 text-xs font-bold mb-2" for="tipo_usuario">
                        Tipo de Usuario
                    </label>
