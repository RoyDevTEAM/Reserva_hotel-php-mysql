...
<div class="container mx-auto px-4 py-12">
        <h1 class="text-2xl font-semibold text-center mb-6">Editar Usuario</h1>
        <div class="max-w-4xl mx-auto bg-white p-8 shadow rounded">
            <form id="formEditarUsuario" class="w-full">
                ...
                <div class="flex flex-wrap -mx-3 mb-6">
                    ...
                    <div class="w-full md:w-1/2 px-3">
                        <label class="block uppercase tracking-wide text-gray-700 text-xs font-bold mb-2" for="tipo_usuario">Tipo de Usuario</label>
                        <select name="tipo_usuario" id="tipo_usuario" required class="block appearance-none w-full bg-gray-200 border border-gray-200 text-gray-700 py-3 px-4 pr-8 rounded leading-tight focus:outline-none focus:bg-white focus:border-gray-500">
